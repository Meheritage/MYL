    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (Convert.ToInt32(dtMobilNoExist.Rows[0][0]) == 0)
            {
                ...
                Session["MobileNO"] = "";
                ClientScript.RegisterStartupScript(this.GetType(), "alert", "alert('உங்கள் தகவல் பதிவுசெய்யப்பட்டுள்ளது. இந்திய யூனியன் முஸ்லிம் லீக்கில் இணைய விருப்பம் தெரிவித்ததற்கு நன்றி. விரைவில் மாவட்ட தலைமையிலிருந்து தொடர்பு கொள்வார்கள்.');window.location.href='https://www.iumltn.in/';", true);
